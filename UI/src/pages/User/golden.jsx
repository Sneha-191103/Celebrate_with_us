...
export default function GoldenPage() {
  ...
  const [packages,setPackage]=useState("Golden");
  ...
  return (
    <div className="premium-page">
      ...
      <div style={{padding:'60px 0 0 0', textAlign:'center'}}>
        <h1>Golden Birthday Party Package</h1>
        <div>
          <p>"Experience the ultimate celebration with our Golden Birthday Party Package. Indulge in delectable cake choices, from rich chocolate to creamy vanilla and vibrant strawberry. Set the mood with our professionally curated DJ party, keeping the dance floor alive with your favorite tunes. Delight your guests with a gourmet selection of food menus, featuring mouthwatering main courses, tantalizing appetizers, and irresistible desserts. Choose from a variety of themed decorations, including options for boys, girls, and adults, to add a personalized touch to your celebration. Elevate your birthday experience with our golden package and create memories that will last a lifetime."</p>
        </div>
        ...
        <div className="section" style={{backgroundColor:'rgb(254, 236, 226)'}}>
          <h1>Theme Choices</h1>
        ...
        <div className="section" style={{backgroundColor:'rgb(247, 222, 208)'}}>
          <h1>Cake Choices</h1>
          <div style={{padding:'0px 40px'}}>
      ...
      <div className='section food-section' style={{backgroundColor:'rgb(243, 215, 202)'}}>
      ...
      <div className="theme-list">
        ...
        <div className="section" style={{backgroundColor:'rgb(226, 191, 179)'}}>
          <h1>DJ Party</h1>
