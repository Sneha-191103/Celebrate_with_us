...
export default function SilverPage() {
  ...
  const [packages,setPackage]=useState("Silver");
  ...
  return (
    <div className="premium-page">
      ...
      <div style={{padding:'60px 0 0 0', textAlign:'center'}}>
        <h1>Silver Birthday Party Package</h1>
        <div>
          <p>"Experience the ultimate celebration with our Silver Birthday Party Package. Indulge in delectable cake choices, from rich chocolate to creamy vanilla and vibrant strawberry. Set the mood with our professionally curated DJ party, keeping the dance floor alive with your favorite tunes. Delight your guests with a gourmet selection of food menus, featuring mouthwatering main courses, tantalizing appetizers, and irresistible desserts. Choose from a variety of themed decorations, including options for boys, girls, and adults, to add a personalized touch to your celebration. Elevate your birthday experience with our Silver package and create memories that will last a lifetime."</p>
        </div>
